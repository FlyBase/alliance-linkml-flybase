# !/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Data retrieval of FlyBase allele disease annotations for Alliance curation database.

Author(s):
    Gil dos Santos dossantos@morgan.harvard.edu

Usage:
    AGR_data_retrieval_curation_disease.py [-h]
    [-l LINKML_RELEASE] [-v VERBOSE] [-c CONFIG] [-t TESTING]

Example:
    python AGR_data_retrieval_curation_disease.py -v -l v1.1.2
...
def main():
    ...
    disease_handler = get_handler(log, FB_DATA_TYPE, testing)
    ...
    export_dict[disease_handler.primary_export_set] = disease_handler.export_data[disease_handler.primary_export_set]
